...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"caritascoin", "coralnode", &coralnode, true, true, false},
        {"caritascoin", "listcoralnodes", &listcoralnodes, true, true, false},
        {"caritascoin", "getcoralnodecount", &getcoralnodecount, true, true, false},
        {"caritascoin", "coralnodeconnect", &coralnodeconnect, true, true, false},
        {"caritascoin", "coralnodecurrent", &coralnodecurrent, true, true, false},
        {"caritascoin", "coralnodedebug", &coralnodedebug, true, true, false},
        {"caritascoin", "startcoralnode", &startcoralnode, true, true, false},
        {"caritascoin", "createcoralnodekey", &createcoralnodekey, true, true, false},
        {"caritascoin", "getcoralnodeoutputs", &getcoralnodeoutputs, true, true, false},
        {"caritascoin", "listcoralnodeconf", &listcoralnodeconf, true, true, false},
        {"caritascoin", "getcoralnodestatus", &getcoralnodestatus, true, true, false},
        {"caritascoin", "getcoralnodewinners", &getcoralnodewinners, true, true, false},
        {"caritascoin", "getcoralnodescores", &getcoralnodescores, true, true, false},
