...
/** Utility functions used by the CaritasCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render CaritasCoin addresses in monospace font
...
// Parse "caritas:" URI into recipient object, return true on successful parsing
