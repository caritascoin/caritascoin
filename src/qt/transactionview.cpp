 ...
 */
    ...
    typeWidget->addItem(tr("Coralnode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::FNReward));
    typeWidget->addItem(tr("Received CaritasCoin from zCRTS"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCRTS"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zVit));
