 ...
 */
    ...
    typeWidget->addItem(tr("Received CaritasCoin from zCARITAS"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCARITAS"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zVit));
