...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CaritasCoin Core"),
     ...
     * override -datadir in the caritas.conf file in the default data directory
     * (to be consistent with caritasd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
