                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CaritasCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CaritasCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and CaritasCoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCARITAS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CaritasCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about CaritasCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CaritasCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CaritasCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CaritasCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a CaritasCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CaritasCoin Core help message to get a list with possible CaritasCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CaritasCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CaritasCoin network", "", count));
}
...
{
    QString strTitle = tr("CaritasCoin Core"); // default title
