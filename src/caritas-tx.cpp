...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CaritasCoin Core caritas-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  caritas-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded caritascoin transaction") + "\n" +
                               "  caritas-tx [options] -create [commands]   " + _("Create hex-encoded caritascoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded caritascoin transaction
