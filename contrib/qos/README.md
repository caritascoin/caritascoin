...
This means one can have an always-on caritasd instance running, and another local caritasd/caritas-qt instance which connects to this node and receives blocks from it.
