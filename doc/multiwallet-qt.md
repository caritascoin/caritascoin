...
In order to support loading of multiple wallets in caritas-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is caritas.cpp.
...
Changes to caritas.cpp
----------------------
caritas.cpp is the entry point into caritas-qt, and as such, will require some minor modifications to provide hooks for
