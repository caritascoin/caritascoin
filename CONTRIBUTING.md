Contributing to CaritasCoin Core
============================

The CaritasCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CaritasCoin Core project, and is not to be
confused with overall CaritasCoin Network Protocol consensus changes.

Whether a pull request is merged into CaritasCoin Core rests with the project merge
...
Patches that change CaritasCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the CaritasCoin consensus, it must have been
...
The project leader is the release manager for each CaritasCoin Core release.
